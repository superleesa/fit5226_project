...
class Evaluation:
    def __init__(self, n=5) -> None:
        ...
        self.dqn_envs = Assignment2Environment(n=3, with_animation=False) # initialize DQN environment
        self.dqn_agent = DQNAgent() # initialize DQN agent
    ...
    def run_dqn_train(self):
        ...
        trainer.train()
        self.dqn_agent.save_state("final_trained_dqn_agent.pth") # save the states
    ...
    def visualize_dqn(self, num_of_vis: int = 5) -> None:
        ...
        Visualize the path after trained
        """
        # Visualize for num_of_vis times
...
if __name__ == "__main__":
    ...
    # DQN Evaluation
    evl = Evaluation()
    # evl.run_dqn_train() # train model
    evl.load_trained_dqn("final_trained_dqn_agent.pth") # load the saved model 
