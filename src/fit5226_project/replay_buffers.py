...
BatchExperience: TypeAlias = tuple[
    torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor
]  # each tensor should not be unsqueeze if they only have one dimension
...
class PrioritizedExperienceBuffer(BaseReplayBuffer):
    ...
    def remember(self, experience: Experience) -> None:
        ...
        )  # max to ensure newly added experience has the highest priority
